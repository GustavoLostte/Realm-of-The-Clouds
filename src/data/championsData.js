...
export const CHAMPIONS_LIST = [
  ...
  // 3. PALADIN (ARCHER) - MALE
  {
    ...
    animations: createChampionAnimations('/CHAMPIONS/PALADIN_MALE', true, true),
    sounds: createChampionSounds('/CHAMPIONS/PALADIN_MALE', true, true),
    scale: 1.0,
    hp: 4800,
    atk: 96,
    def: 82,
  ...
  // 4. PALADIN (ARCHER) - FEMALE
  {
    ...
    animations: createChampionAnimations('/CHAMPIONS/PALADIN_FEMALE', true, true),
    sounds: createChampionSounds('/CHAMPIONS/PALADIN_FEMALE', true, true),
    scale: 1.0,
    hp: 4700,
    atk: 98,
    def: 80,
