...
export const CHAPTERS_DATA = [
  {
    id: 1,
    title: 'Capítulo I: El Renacer del Feudo',
    subtitle: 'Reconstruye las murallas y consolida tu primer asentamiento en la meseta.',
    badge: 'Capítulo I',
    icon: '/assets/hud_icons/btn_build.webp',
  },
  {
    id: 2,
    title: 'Capítulo II: La Amenaza de los Páramos',
    subtitle: 'Repele la incursión orca y refuerza la capacidad militar de la ciudad.',
    badge: 'Capítulo II',
    icon: '/assets/hud_icons/btn_army.webp',
  },
  {
    id: 3,
    title: 'Capítulo III: La Sombra del Caudillo',
    subtitle: 'Derrota a las bestias elementales y destruye al temible Vorgath.',
    badge: 'Capítulo III',
    icon: '/assets/hud_icons/icon_skull.webp',
  },
  {
    id: 4,
    title: 'Capítulo IV: La Era del Gran Imperio',
    subtitle: 'Domina los portales cósmicos y alza el trono más glorioso del reino.',
    badge: 'Capítulo IV',
...
export const KINGDOM_LEVELS = [
  ...
  },
  {
    ...
    xpRequired: 1000,
    unlocks: ['Portal Arcano del Caos', 'Mejoras de Fortaleza Nivel II', '+10% Producción Global'],
    reward: { gold: 600, gems: 30, wood: 300, stone: 300 },
  },
  {
    level: 4,
    title: 'Reino del Trono de Caos',
    xpRequired: 2000,
